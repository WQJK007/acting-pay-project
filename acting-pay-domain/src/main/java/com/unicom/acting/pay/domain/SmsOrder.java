...
/**
 * 短信中心工单对象，主要用于记录短信工单记录
 *
 * @author Wangkh
 */
public class SmsOrder implements Cloneable {
    ...
    @Override
    public SmsOrder clone() {
        try {
            return (SmsOrder) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new SkyArkException(SysTypes.BUSI_ERROR_CODE, "SmsOrder clone error");
        }
    }
